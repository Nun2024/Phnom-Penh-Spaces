        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter mb-lg">
          <div className="bg-surface-container-lowest p-md rounded-xl custom-shadow card-hover">
            <div className="flex justify-between items-start mb-sm">
              ...
              <span className="text-label-sm font-label-sm text-primary-container bg-primary-container/5 px-2 py-1 rounded-full">
                +12%
              </span>
            </div>
        ...
        <div className="bg-surface-container-lowest rounded-xl custom-shadow overflow-hidden">
          <div className="px-md py-md border-b border-outline-variant flex justify-between items-center">
            ...
            <div className="flex items-center gap-sm">
              <button className="text-label-md font-label-md text-on-surface-variant hover:text-primary flex items-center gap-xs">
                <span
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-surface-container text-on-surface-variant">
                  <th className="px-md py-sm font-label-md text-label-md">
                    Customer
                  </th>
                  <th className="px-md py-sm font-label-md text-label-md">
                    Space
                  ...
                  <th className="px-md py-sm font-label-md text-label-md text-right">
                    Actions
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-outline-variant/30">
                ...
                <tr className="hover:bg-surface-container-low transition-colors group">
                  ...
                  <td className="px-md py-md">
                    <span className="px-3 py-1 rounded-full bg-primary-container/10 text-on-primary-container text-xs font-bold">
                      Confirmed
                    </span>
                  </td>
                ...
                <tr className="hover:bg-surface-container-low transition-colors group">
                  <td className="px-md py-md">
                    <div className="flex items-center gap-sm">
                      <div className="w-8 h-8 rounded-full bg-tertiary-fixed-dim/20 flex items-center justify-center text-xs font-bold text-tertiary">
                        KL
                      </div>
                      <div>
                        <p className="font-label-md text-label-md text-on-surface">
                ...
                <tr className="hover:bg-surface-container-low transition-colors group">
                  ...
                  <td className="px-md py-md">
                    <span className="px-3 py-1 rounded-full bg-error-container/20 text-on-tertiary-container text-xs font-bold">
                      Cancelled
                    </span>
                  </td>
                  <td className="px-md py-md text-right">
          ...
          <div className="px-md py-sm bg-surface-container-low border-t border-outline-variant flex items-center justify-between text-xs text-on-surface-variant">
            ...
            <div className="flex gap-xs">
              ...
              <button className="w-8 h-8 flex items-center justify-center bg-primary text-on-primary rounded">
                1
              </button>
              <button className="w-8 h-8 flex items-center justify-center border border-outline-variant rounded hover:bg-surface-container-high">
                2
          ...
          <div className="bg-surface-container-lowest rounded-xl custom-shadow relative overflow-hidden h-64 group">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-md">
              ...
              <p className="text-white/80 text-xs">
                Phnom Penh, Cambodia • 12 Active Spots
              </p>
            </div>
            <button className="absolute top-md right-md bg-white p-2 rounded-full custom-shadow text-primary hover:scale-110 transition-transform">
              <span
                className="material-symbols-outlined"
